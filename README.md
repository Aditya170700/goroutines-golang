# Belajar Goroutines Bahasa Go (Golang)

Selamat datang! Repository ini berisi file pembelajaran goroutines di bahasa pemrograman Go (Golang). Repository ini dibuat untuk dokumentasi pembelajaran saya yang memulai perjalanan dalam mempelajari bahasa Go (Golang).
